...
export default function TanHoaImportPage() {
  ...
  const save = async () => {
    ...
    setMessage("");
    try {
      const response = await api.post("/TanHoa/import", rows);
      setMessage(`Đã import thành công ${response.data.savedCount} dòng dữ liệu Tân Hòa.`);
      setRows([]);
  ...
  return <div className="container-fluid px-0">
    <div className="card shadow-sm mb-4"><div className="card-body">
      <h5 className="fw-bold text-primary">Import dữ liệu Tân Hòa</h5>
      ...
      <div className="row g-3 align-items-end">
        <div className="col-md-9"><label htmlFor="tan-hoa-file" className="form-label">File Excel</label><input id="tan-hoa-file" ref={inputRef} type="file" accept=".xlsx,.xls" className="form-control" disabled={busy} onChange={readFile} /></div>
