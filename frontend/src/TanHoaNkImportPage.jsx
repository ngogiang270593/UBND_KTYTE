...
export default function TanHoaNkImportPage() {
  ...
  const save = async () => {
    ...
    setMessage("");
    try {
      const response = await api.post("/TanHoaNk/import", rows);
      setMessage(`Đã import thành công ${response.data.savedCount} dòng dữ liệu NK Tân Hòa.`);
      setRows([]);
  ...
  return <div className="container-fluid px-0">
    <div className="card shadow-sm mb-4"><div className="card-body">
      <h5 className="fw-bold text-primary">Import dữ liệu NK Tân Hòa</h5>
      <p className="text-muted">Dòng 1 là tiêu đề. Dữ liệu từ dòng 2, cột A đến F theo thứ tự: CMND/CCCD, Ngày sinh, Năm sinh, Họ và Tên, Địa chỉ, Số thẻ BHYT.</p>
      ...
      <div className="row g-3 align-items-end">
        <div className="col-md-9"><label htmlFor="tan-hoa-nk-file" className="form-label">File Excel</label><input id="tan-hoa-nk-file" ref={inputRef} type="file" accept=".xlsx,.xls" className="form-control" disabled={busy} onChange={readFile} /></div>
